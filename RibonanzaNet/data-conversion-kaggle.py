...
Purpose: Converts and splits Kaggle RNA sequence/label data for model training/validation.
"""
import pandas as pd
...
new_training_sequences = pd.concat([training_sequences, training_sequences_v2], ignore_index=True)
new_training_labels = pd.concat([training_labels, training_labels_v2], ignore_index=True)
